...
// GetLinksInner defines model for GetLinksInner.
type GetLinksInner struct {
	Links []struct {
		ID    string `json:"id"`
...
// GetLinksOuter defines model for GetLinksOuter.
type GetLinksOuter struct {
	Links []GetLinksInner `json:"links"`
}
...
// GetTripParticipantsOuter defines model for GetTripParticipantsOuter.
type GetTripParticipantsOuter struct {
	Participants []GetTripParticipantsInner `json:"participants"`
}

// GetTripsDetailsInner defines model for GetTripsDetailsInner.
type GetTripsDetailsInner struct {
...
// GetTripsDetailsOuter defines model for GetTripsDetailsOuter.
type GetTripsDetailsOuter struct {
	Trip GetTripsDetailsInner `json:"trip"`
}

// PostActivitiesContent defines model for PostActivitiesContent.
type PostActivitiesContent struct {
	OccursAt time.Time `json:"occurs_at"`
	Title    string    `json:"title"`
}

// PostActivitiesResponse defines model for PostActivitiesResponse.
type PostActivitiesResponse struct {
	ActivityID string `json:"activityId"`
}

// PostCreateLinksContent defines model for PostCreateLinksContent.
type PostCreateLinksContent struct {
	Title string `json:"title"`
	URL   string `json:"url"`
}

// PostCreateLinksResponse defines model for PostCreateLinksResponse.
type PostCreateLinksResponse struct {
	LinkID string `json:"linkId"`
}

// PostParticipants defines model for PostParticipants.
type PostParticipants struct {
	Email openapi_types.Email `json:"email"`
}

// PostTripsContent defines model for PostTripsContent.
type PostTripsContent struct {
	Destination    string                `json:"destination"`
...
// UpdateTripsContent defines model for UpdateTripsContent.
type UpdateTripsContent struct {
	Destination string    `json:"destination"`
	EndsAt      time.Time `json:"ends_at"`
	StartsAt    time.Time `json:"starts_at"`
}
...
// A *Response is returned with the configured status code and content type from the spec.
func GetTripsTripIDJSON200Response(body GetTripsDetailsOuter) *Response {
	return &Response{
		body:        body,
		Code:        200,
		contentType: "application/json",
...
// A *Response is returned with the configured status code and content type from the spec.
func PostTripsTripIDActivitiesJSON201Response(body PostActivitiesResponse) *Response {
	return &Response{
		body:        body,
		Code:        201,
		contentType: "application/json",
...
// A *Response is returned with the configured status code and content type from the spec.
func GetTripsTripIDLinksJSON200Response(body GetLinksOuter) *Response {
	return &Response{
		body:        body,
		Code:        200,
		contentType: "application/json",
...
// A *Response is returned with the configured status code and content type from the spec.
func PostTripsTripIDLinksJSON201Response(body PostCreateLinksResponse) *Response {
	return &Response{
		body:        body,
		Code:        201,
		contentType: "application/json",
...
// A *Response is returned with the configured status code and content type from the spec.
func GetTripsTripIDParticipantsJSON200Response(body GetTripParticipantsOuter) *Response {
	return &Response{
		body:        body,
		Code:        200,
		contentType: "application/json",
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+Ra3W7bNhR+FYLbpRKnW6501yZF4SHYjKLDLooiYKTjmI1EauRRAsPw0+xiV7vcE+TF",
	"CpKyTFmMLSl2A6c3qSrz55zzffz4kfaCJjIvpACBmsYLqpMZ5Mw+vldKKvPA0pQjl4JlEyULUMhB03jK",
	"Mg0RTUEnihfmcxrTdywlCv4uQSONaOE1X9ActGa3YB5xXgCNqUbFxS1dLiNqOnEFKY0/1w2/RKuG8uYr",
	"JEiXEf0AeMXFnR4LAbuDawaQmY7mgSPkumdnnpq/U6lyhjSmZclTGm0mElHkmIVSjGipsuYIircH2KiE",
	"m8MO6QYIlaR6wZRi89YILudtlfyjxD1U8mcFUxrTn0ZrOo0qLo2amD0r4k+KF28T5PfchDKEBB1xlElS",
